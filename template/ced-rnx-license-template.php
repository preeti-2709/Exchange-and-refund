...
<div style="padding: 10px">
	...
	<div style="text-align: justify; float: left; width: 85%; font-size: 16px; line-height: 25px; padding-right: 4%;">
		<?php
		_e( 'This is the License Activation Panel. After purchasing extension from Codecanyon you will get the purchase code of this plugin. Please verify your purchase below so that you can use feature of this extension.', 'woocommerce-refund-and-exchange' );
		?>
