									...
									<div class="ced_rnx_catalog_toggle" >
										<table id="ced_rnx_catalog_table">
											...
											<tr>	
												...
												<td><input type="number" min="0" placeholder="<?php _e( 'Enter Return Days', 'woocommerce-refund-and-exchange' ); ?>"  value="<?php echo $value['refund']; ?>" name="ced_rnx_catalog_refund_days<?php echo $counter; ?>" class="ced_rnx_catalog_refund_days"><span><?php _e( '[If value is 0 then catalog will not work.]', 'woocommerce-refund-and-exchange' ); ?></span></td>
											</tr><tr>
							...
							<div class="ced_rnx_catalog_toggle" >
								<table id="ced_rnx_catalog_table">
									...
									<tr>	
										...
										<th><label><strong><?php _e( 'Maximum Return Days:', 'woocommerce-refund-and-exchange' ); ?></strong></label></th>
			...
			if ( 'exchange' == $current_section ) {
				$settings = array(
					...
					array(
						...
						'desc'          => __( 'Exclude Shipping fee to Exchange amount.', 'woocommerce-refund-and-exchange' ),
						'default'       => 'no',
						'type'          => 'checkbox',
