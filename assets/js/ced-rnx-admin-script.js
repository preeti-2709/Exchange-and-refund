jQuery(document).ready(function(){
	...
	jQuery("#ced_rnx_accept_warranty_repair").click(function(){
		console.log('ced_rnx_accept_return');
		...
		jQuery(".ced_rnx_warranty_column").each(function(){
			var product_info = {};
			var product_id = jQuery(this).data("productid");
			var rowkey = jQuery(this).data("rowkey");
			var approve_status = jQuery(this).find('#approve_status').val();
			var sku = jQuery(this).data('sku_id');
			if(approve_status){
			}else{
			    approve_status = '3';
			}
			product_info['order_id'] = orderid;
			product_info['product_id'] = product_id;
			product_info['rowkey'] = rowkey;
			product_info['sku'] = sku;
			product_info['approve_status'] = approve_status;
			selected_product[rowkey] = product_info;

		});
		var data = {
				// action:'ced_return_req_approve',
				action:'ced_warranty_req_approve',
				orderid:orderid,
				date:date,
	...
	// new approve button add - 30-11-22
	jQuery("#ced_rnx_accept_warranty").click(function(){
		console.log('i am ced_rnx_accept_warranty');
		...
		var data = {
			action:'ced_warranty_req_approve_first_level',
			orderid:orderid,
			date:date,
			selected_product:selected_product,
			security_check	:	global_rnx.ced_rnx_nonce	
	...
	jQuery("#ced_rnx_reject_exchange").click(function(){
		jQuery(".ced_rnx_exchange_loader").show();
		var orderid = jQuery(this).data('orderid');
		var date = jQuery(this).data('date');
		var selected_product = {};
		jQuery(".ced_rnx_exchange_column").each(function(){
			var product_info = {};
			var product_id = jQuery(this).data("productid");
			var key = jQuery(this).find('.product-name-to').data("key");
			var approve_status = jQuery(this).find('#approve_status').val();
			var sku = jQuery(this).find('.product-name-to').data('sku_id');
			if(approve_status){
			}else{
			    approve_status = '3';
			}
			product_info['order_id'] = orderid;
			product_info['product_id'] = product_id;
			product_info['rowkey'] = key;
			product_info['sku'] = sku;
			product_info['approve_status'] = approve_status;
			selected_product[key] = product_info;
		});
		var data = {
				action:'ced_exchange_req_rejected',
				selected_product:selected_product,
				orderid:orderid,
				date:date,
				security_check	:	global_rnx.ced_rnx_nonce	
	...
	jQuery("#ced_rnx_warranty_rejected").click(function(){
		jQuery(".ced_rnx_return_loader").show();
		var orderid = jQuery(this).data('orderid');
		var date = jQuery(this).data('date');
		var selected_product = {};
	...
	// new approve button add - 18-11-22
	jQuery("#ced_rnx_accept_exchange_request").click(function(){
		jQuery(".ced_rnx_exchange_loader").show();
		var orderid = jQuery(this).data('orderid');
		var date = jQuery(this).data('date');
		var selected_product = {};
		jQuery(".ced_rnx_exchange_column").each(function(){
				...
				var key = jQuery(this).find('.product-name-to').data("key");
				var approve_status = jQuery(this).find('#approve_status').val();
				var item_id = jQuery(this).find('.product-name-to').data('item_id');
				console.log(approve_status);
				product_info['order_id'] = orderid;
				product_info['product_id'] = product_id;
				product_info['rowkey'] = key;
				product_info['approve_status'] = approve_status;
				product_info['id'] = item_id;
				selected_product[key] = product_info;

		});
		//console.log(selected_product);
		var data = {
			action:'ced_exchange_req_approve_first_level',
			selected_product:selected_product,
			orderid:orderid,
			date:date,
			security_check	:	global_rnx.ced_rnx_nonce	
